...
From our experiments, decreasing the window size used slightly improved the precision recall score. This points to the effectiveness of kNN in reducing the set of items within a large dataset to its most similiar ones.
